                        ...
                        <div>
                          <div className="flex justify-between">
                            <h3 className="text-sm">
                              <Link href={product.href} className="font-semibold text-black">
                                {product.title}
                              </Link>
                            </h3>
                          </div>
                  ...
                  <div className="mb-2 flex">
                    ...
                    <div className="ml-6 flex text-sm">
                      <button type="button" className="flex items-center space-x-1 px-2 py-1 pl-0">
                        ...
                        <span className="text-xs font-medium text-red-500"  onClick={()=>{
                          dispatch(deleteCart(product));
                        }} >Remove</span>
                      </button>
                    </div>
            ...
            <div>
              <dl className=" space-y-1 px-2 py-4">
                <div className="flex items-center justify-between">
                  <dt className="text-sm text-gray-800">Price ({cart.item} item)</dt>
